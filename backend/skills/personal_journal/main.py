"""Personal journal skill: read, write, append, list, and move daily Markdown entries.

Full access to data/memories/main/journal/personal. Files are YYYY-MM-dd.md.
...
class PersonalJournalSkill(BaseSkill):
    """Manage personal journal entries as daily Markdown files (YYYY-MM-dd.md)."""
    ...
    def tools(self) -> list[ToolDefinition]:
        return [
            ToolDefinition(
                name="list_entries",
                description=(
                    "List personal journal entry dates (YYYY-MM-dd) in reverse chronological order. "
            ...
            ToolDefinition(
                name="read_entry",
                description=(
                    "Read the full content of the personal journal for a given date. "
            ...
            ToolDefinition(
                name="write_entry",
                description=(
                    "Create or overwrite the personal journal file for a date with Markdown content. "
            ...
            ToolDefinition(
                ...
                description=(
                    "Append a section to an existing personal journal entry (or create the file). "
                    "Use for adding an evening section, follow-up note, or additional heading. "
                ...
                parameters={
                    ...
                    "properties": {
                        ...
                        "section_heading": {
                            "type": "string",
                            "description": "Optional ## heading for this block (e.g. 'Evening')",
                        },
                    },
                },
                required=["date", "content"],
            ...
            ToolDefinition(
                name="move_entry",
                description=(
                    "Move (rename) a personal journal entry from one date to another. "
    ...
    async def execute(self, tool_name: str, params: dict[str, Any]) -> SkillResult:
        ...
        try:
            ...
            log.warning("personal_journal_io_error", tool=tool_name, error=str(e))
            return SkillResult(tool_name=tool_name, success=False, error=str(e))


skill = PersonalJournalSkill()
